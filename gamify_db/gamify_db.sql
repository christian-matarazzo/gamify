...
CREATE TABLE `billing_addresses` (
  ...
  CONSTRAINT `billing_addresses_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE
...
INSERT INTO `coupon` VALUES (1,'WELCOME10',10.00,NULL,1),(2,'EXPIRED10',10.00,'2026-05-10 11:17:34',1);
...
INSERT INTO `game_keys` VALUES (1,1,'AC-SHADOW-KEY-001-TEST','available'),(2,1,'AC-SHADOW-KEY-002-TEST','available'),(3,1,'AC-SHADOW-KEY-003-TEST','available'),(4,1,'AC-SHADOW-KEY-004-TEST','available'),(5,1,'AC-SHADOW-KEY-005-TEST','available'),(6,2,'ALIEN-ISO-KEY-001-TEST','available'),(7,2,'ALIEN-ISO-KEY-002-TEST','available'),(8,2,'ALIEN-ISO-KEY-003-TEST','available'),(9,3,'ATOMIC-KEY-001-TEST','available'),(10,3,'ATOMIC-KEY-002-TEST','available'),(11,3,'ATOMIC-KEY-003-TEST','available'),(12,3,'ATOMIC-KEY-004-TEST','available'),(13,3,'ATOMIC-KEY-005-TEST','available'),(14,3,'ATOMIC-KEY-006-TEST','available'),(15,4,'DAWN-KEY-001-TEST','available'),(16,4,'DAWN-KEY-002-TEST','available'),(17,4,'DAWN-KEY-003-TEST','available'),(18,4,'DAWN-KEY-004-TEST','available'),(19,4,'DAWN-KEY-005-TEST','available'),(20,4,'DAWN-KEY-006-TEST','available'),(21,5,'COD7-KEY-001-TEST','available'),(22,5,'COD7-KEY-002-TEST','available'),(23,5,'COD7-KEY-003-TEST','available'),(24,5,'COD7-KEY-004-TEST','available'),(25,5,'COD7-KEY-005-TEST','available'),(26,5,'COD7-KEY-006-TEST','available'),(27,6,'CRIM-KEY-001-TEST','available'),(28,6,'CRIM-KEY-002-TEST','available'),(29,6,'CRIM-KEY-003-TEST','available'),(30,6,'CRIM-KEY-004-TEST','available'),(31,6,'CRIM-KEY-005-TEST','available'),(32,6,'CRIM-KEY-006-TEST','available'),(33,7,'CYBER-KEY-001-TEST','available'),(34,7,'CYBER-KEY-002-TEST','available'),(35,7,'CYBER-KEY-003-TEST','available'),(36,7,'CYBER-KEY-004-TEST','available'),(37,7,'CYBER-KEY-005-TEST','available'),(38,7,'CYBER-KEY-006-TEST','available'),(39,8,'DAYS-KEY-001-TEST','available'),(40,8,'DAYS-KEY-002-TEST','available'),(41,8,'DAYS-KEY-003-TEST','available'),(42,8,'DAYS-KEY-004-TEST','available'),(43,8,'DAYS-KEY-005-TEST','available'),(44,8,'DAYS-KEY-006-TEST','available'),(45,9,'DS2-KEY-001-TEST','available'),(46,9,'DS2-KEY-002-TEST','available'),(47,9,'DS2-KEY-003-TEST','available'),(48,9,'DS2-KEY-004-TEST','available'),(49,9,'DS2-KEY-005-TEST','available'),(50,9,'DS2-KEY-006-TEST','available'),(51,10,'DMC5-KEY-001-TEST','available'),(52,10,'DMC5-KEY-002-TEST','available'),(53,10,'DMC5-KEY-003-TEST','available'),(54,10,'DMC5-KEY-004-TEST','available'),(55,10,'DMC5-KEY-005-TEST','available'),(56,10,'DMC5-KEY-006-TEST','available'),(57,11,'DIAB4-KEY-001-TEST','available'),(58,11,'DIAB4-KEY-002-TEST','available'),(59,11,'DIAB4-KEY-003-TEST','available'),(60,11,'DIAB4-KEY-004-TEST','available'),(61,11,'DIAB4-KEY-005-TEST','available'),(62,11,'DIAB4-KEY-006-TEST','available'),(63,12,'DIR8-KEY-001-TEST','available'),(64,12,'DIR8-KEY-002-TEST','available'),(65,12,'DIR8-KEY-003-TEST','available'),(66,12,'DIR8-KEY-004-TEST','available'),(67,12,'DIR8-KEY-005-TEST','available'),(68,12,'DIR8-KEY-006-TEST','available'),(69,13,'ER-KEY-001-TEST','available'),(70,13,'ER-KEY-002-TEST','available'),(71,13,'ER-KEY-003-TEST','available'),(72,13,'ER-KEY-004-TEST','available'),(73,13,'ER-KEY-005-TEST','available'),(74,13,'ER-KEY-006-TEST','available'),(75,14,'ERNR-KEY-001-TEST','available'),(76,14,'ERNR-KEY-002-TEST','available'),(77,14,'ERNR-KEY-003-TEST','available'),(78,14,'ERNR-KEY-004-TEST','available'),(79,14,'ERNR-KEY-005-TEST','available'),(80,14,'ERNR-KEY-006-TEST','available'),(81,15,'TARKOV-KEY-001-TEST','available'),(82,15,'TARKOV-KEY-002-TEST','available'),(83,15,'TARKOV-KEY-003-TEST','available'),(84,15,'TARKOV-KEY-004-TEST','available'),(85,15,'TARKOV-KEY-005-TEST','available'),(86,15,'TARKOV-KEY-006-TEST','available'),(87,16,'FORZA-KEY-001-TEST','available'),(88,16,'FORZA-KEY-002-TEST','available'),(89,16,'FORZA-KEY-003-TEST','available'),(90,16,'FORZA-KEY-004-TEST','available'),(91,16,'FORZA-KEY-005-TEST','available'),(92,16,'FORZA-KEY-006-TEST','available'),(93,17,'GOW-KEY-001-TEST','available'),(94,17,'GOW-KEY-002-TEST','available'),(95,17,'GOW-KEY-003-TEST','available'),(96,17,'GOW-KEY-004-TEST','available'),(97,17,'GOW-KEY-005-TEST','available'),(98,17,'GOW-KEY-006-TEST','available'),(99,18,'GOTHAM-KEY-001-TEST','available'),(100,18,'GOTHAM-KEY-002-TEST','available'),(101,18,'GOTHAM-KEY-003-TEST','available'),(102,18,'GOTHAM-KEY-004-TEST','available'),(103,18,'GOTHAM-KEY-005-TEST','available'),(104,18,'GOTHAM-KEY-006-TEST','available'),(105,19,'HOGW-KEY-001-TEST','available'),(106,19,'HOGW-KEY-002-TEST','available'),(107,19,'HOGW-KEY-003-TEST','available'),(108,19,'HOGW-KEY-004-TEST','available'),(109,19,'HOGW-KEY-005-TEST','available'),(110,19,'HOGW-KEY-006-TEST','available'),(111,20,'LOP-KEY-001-TEST','available'),(112,20,'LOP-KEY-002-TEST','available'),(113,20,'LOP-KEY-003-TEST','available'),(114,20,'LOP-KEY-004-TEST','available'),(115,20,'LOP-KEY-005-TEST','available'),(116,20,'LOP-KEY-006-TEST','available'),(117,21,'MGSD-KEY-001-TEST','available'),(118,21,'MGSD-KEY-002-TEST','available'),(119,21,'MGSD-KEY-003-TEST','available'),(120,21,'MGSD-KEY-004-TEST','available'),(121,21,'MGSD-KEY-005-TEST','available'),(122,21,'MGSD-KEY-006-TEST','available'),(123,22,'META-KEY-001-TEST','available'),(124,22,'META-KEY-002-TEST','available'),(125,22,'META-KEY-003-TEST','available'),(126,22,'META-KEY-004-TEST','available'),(127,22,'META-KEY-005-TEST','available'),(128,22,'META-KEY-006-TEST','available'),(129,23,'NIER-KEY-001-TEST','available'),(130,23,'NIER-KEY-002-TEST','available'),(131,23,'NIER-KEY-003-TEST','available'),(132,23,'NIER-KEY-004-TEST','available'),(133,23,'NIER-KEY-005-TEST','available'),(134,23,'NIER-KEY-006-TEST','available'),(135,24,'NIOH3-KEY-001-TEST','available'),(136,24,'NIOH3-KEY-002-TEST','available'),(137,24,'NIOH3-KEY-003-TEST','available'),(138,24,'NIOH3-KEY-004-TEST','available'),(139,24,'NIOH3-KEY-005-TEST','available'),(140,24,'NIOH3-KEY-006-TEST','available'),(141,25,'P3-KEY-001-TEST','available'),(142,25,'P3-KEY-002-TEST','available'),(143,25,'P3-KEY-003-TEST','available'),(144,25,'P3-KEY-004-TEST','available'),(145,25,'P3-KEY-005-TEST','available'),(146,25,'P3-KEY-006-TEST','available'),(147,26,'PRAG-KEY-001-TEST','available'),(148,26,'PRAG-KEY-002-TEST','available'),(149,26,'PRAG-KEY-003-TEST','available'),(150,26,'PRAG-KEY-004-TEST','available'),(151,26,'PRAG-KEY-005-TEST','available'),(152,26,'PRAG-KEY-006-TEST','available'),(153,27,'RDR2-KEY-001-TEST','available'),(154,27,'RDR2-KEY-002-TEST','available'),(155,27,'RDR2-KEY-003-TEST','available'),(156,27,'RDR2-KEY-004-TEST','available'),(157,27,'RDR2-KEY-005-TEST','available'),(158,27,'RDR2-KEY-006-TEST','available'),(159,28,'RE-KEY-001-TEST','available'),(160,28,'RE-KEY-002-TEST','available'),(161,28,'RE-KEY-003-TEST','available'),(162,28,'RE-KEY-004-TEST','available'),(163,28,'RE-KEY-005-TEST','available'),(164,28,'RE-KEY-006-TEST','available'),(165,29,'STALKER-KEY-001-TEST','available'),(166,29,'STALKER-KEY-002-TEST','available'),(167,29,'STALKER-KEY-003-TEST','available'),(168,29,'STALKER-KEY-004-TEST','available'),(169,29,'STALKER-KEY-005-TEST','available'),(170,29,'STALKER-KEY-006-TEST','available'),(171,30,'TOKON-KEY-001-TEST','available'),(172,30,'TOKON-KEY-002-TEST','available'),(173,30,'TOKON-KEY-003-TEST','available'),(174,30,'TOKON-KEY-004-TEST','available'),(175,30,'TOKON-KEY-005-TEST','available'),(176,30,'TOKON-KEY-006-TEST','available'),(177,31,'MHW-KEY-001-TEST','available'),(178,31,'MHW-KEY-002-TEST','available'),(179,31,'MHW-KEY-003-TEST','available'),(180,31,'MHW-KEY-004-TEST','available'),(181,31,'MHW-KEY-005-TEST','available'),(182,31,'MHW-KEY-006-TEST','available'),(183,32,'PB-KEY-001-TEST','available'),(184,32,'PB-KEY-002-TEST','available'),(185,32,'PB-KEY-003-TEST','available'),(186,32,'PB-KEY-004-TEST','available'),(187,32,'PB-KEY-005-TEST','available'),(188,32,'PB-KEY-006-TEST','available'),(189,33,'TWW3-KEY-001-TEST','available'),(190,33,'TWW3-KEY-002-TEST','available'),(191,33,'TWW3-KEY-003-TEST','available'),(192,33,'TWW3-KEY-004-TEST','available'),(193,33,'TWW3-KEY-005-TEST','available'),(194,33,'TWW3-KEY-006-TEST','available'),(195,34,'WOW-KEY-001-TEST','available'),(196,34,'WOW-KEY-002-TEST','available'),(197,34,'WOW-KEY-003-TEST','available'),(198,34,'WOW-KEY-004-TEST','available'),(199,34,'WOW-KEY-005-TEST','available'),(200,34,'WOW-KEY-006-TEST','available'),(201,35,'BEYOND-KEY-001-TEST','available'),(202,35,'BEYOND-KEY-002-TEST','available'),(203,35,'BEYOND-KEY-003-TEST','available'),(204,35,'BEYOND-KEY-004-TEST','available'),(205,35,'BEYOND-KEY-005-TEST','available'),(206,35,'BEYOND-KEY-006-TEST','available'),(207,36,'CRASH-KEY-001-TEST','available'),(208,36,'CRASH-KEY-002-TEST','available'),(209,36,'CRASH-KEY-003-TEST','available'),(210,36,'CRASH-KEY-004-TEST','available'),(211,36,'CRASH-KEY-005-TEST','available'),(212,36,'CRASH-KEY-006-TEST','available'),(213,37,'DMC-KEY-001-TEST','available'),(214,37,'DMC-KEY-002-TEST','available'),(215,37,'DMC-KEY-003-TEST','available'),(216,37,'DMC-KEY-004-TEST','available'),(217,37,'DMC-KEY-005-TEST','available'),(218,37,'DMC-KEY-006-TEST','available'),(219,38,'DINO-KEY-001-TEST','available'),(220,38,'DINO-KEY-002-TEST','available'),(221,38,'DINO-KEY-003-TEST','available'),(222,38,'DINO-KEY-004-TEST','available'),(223,38,'DINO-KEY-005-TEST','available'),(224,38,'DINO-KEY-006-TEST','available'),(225,39,'GOWR-KEY-001-TEST','available'),(226,39,'GOWR-KEY-002-TEST','available'),(227,39,'GOWR-KEY-003-TEST','available'),(228,39,'GOWR-KEY-004-TEST','available'),(229,39,'GOWR-KEY-005-TEST','available'),(230,39,'GOWR-KEY-006-TEST','available'),(231,40,'HALO-KEY-001-TEST','available'),(232,40,'HALO-KEY-002-TEST','available'),(233,40,'HALO-KEY-003-TEST','available'),(234,40,'HALO-KEY-004-TEST','available'),(235,40,'HALO-KEY-005-TEST','available'),(236,40,'HALO-KEY-006-TEST','available'),(237,41,'GTAVC-KEY-001-TEST','available'),(238,41,'GTAVC-KEY-002-TEST','available'),(239,41,'GTAVC-KEY-003-TEST','available'),(240,41,'GTAVC-KEY-004-TEST','available'),(241,41,'GTAVC-KEY-005-TEST','available'),(242,41,'GTAVC-KEY-006-TEST','available');
...
CREATE TABLE `order_items` (
  ...
  `game_title` varchar(255) NOT NULL DEFAULT 'Unknown Game',
...
CREATE TABLE `support_tickets` (
  ...
  CONSTRAINT `support_tickets_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-14 15:08:31
